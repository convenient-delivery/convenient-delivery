...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SaleItem.establishment'
        db.add_column(u'order_processor_saleitem', 'establishment',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SaleItem.establishment'
        db.delete_column(u'order_processor_saleitem', 'establishment_id')

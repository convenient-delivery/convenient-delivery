...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Establishment.city'
        db.add_column(u'order_processor_establishment', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.City'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Establishment.city'
        db.delete_column(u'order_processor_establishment', 'city_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'order_processor_order', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=50, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'order_processor.order': {
            ...
            'establishment': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['order_processor.Establishment']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Order._cost' to match new field type.
        db.rename_column(u'order_processor_order', 'cost', '_cost')
        # Changing field 'Order._cost'
        db.alter_column(u'order_processor_order', '_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=50, decimal_places=2))

    def backwards(self, orm):

        # Renaming column for 'Order._cost' to match new field type.
        db.rename_column(u'order_processor_order', '_cost', 'cost')
        # Changing field 'Order._cost'
        db.alter_column(u'order_processor_order', 'cost', self.gf('django.db.models.fields.DecimalField')(null=True, decimal_places=2, db_column='cost', max_digits=50))
    ...
    models = {
        ...
        u'order_processor.order': {
            ...
            '_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '50', 'decimal_places': '2'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order_processor.City']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.address_line_2'
        db.alter_column(u'order_processor_address', 'address_line_2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Address.address_line_2'
        raise RuntimeError("Cannot reverse this migration. 'Address.address_line_2' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Address.address_line_2'
        db.alter_column(u'order_processor_address', 'address_line_2', self.gf('django.db.models.fields.CharField')(max_length=255))

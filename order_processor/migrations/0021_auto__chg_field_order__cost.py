...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'order_processor_order', 'cost', self.gf('django.db.models.fields.DecimalField')(null=True, db_column='cost', decimal_places=2, max_digits=50))

    def backwards(self, orm):

        # Changing field 'Order._cost'
        db.alter_column(u'order_processor_order', 'cost', self.gf('django.db.models.fields.DecimalField')(decimal_places=2, db_column='cost', max_digits=50))
    ...
    models = {
        ...
        u'order_processor.order': {
            ...
            '_cost': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'null': 'True', 'db_column': "'cost'", 'decimal_places': '2', 'max_digits': '50'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order_processor.City']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Order.order' to match new field type.
        db.rename_column(u'order_processor_order', 'order', 'order_id')
        # Changing field 'Order.order'
        db.alter_column(u'order_processor_order', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.SaleItem'], null=True))
        # Adding index on 'Order', fields ['order']
        db.create_index(u'order_processor_order', ['order_id'])


    def backwards(self, orm):
        # Removing index on 'Order', fields ['order']
        db.delete_index(u'order_processor_order', ['order_id'])
        ...
        # Renaming column for 'Order.order' to match new field type.
        db.rename_column(u'order_processor_order', 'order_id', 'order')
        # Changing field 'Order.order'
        db.alter_column(u'order_processor_order', 'order', self.gf('django.db.models.fields.TextField')())

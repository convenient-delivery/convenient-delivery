...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.items'
        db.delete_column(u'order_processor_order', 'items_id')

        # Deleting field 'Order.establishment'
        db.delete_column(u'order_processor_order', 'establishment_id')

        # Adding M2M table for field items on 'Order'
        m2m_table_name = db.shorten_name(u'order_processor_order_items')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm[u'order_processor.order'], null=False)),
            ('saleitem', models.ForeignKey(orm[u'order_processor.saleitem'], null=False))
        ))
        db.create_unique(m2m_table_name, ['order_id', 'saleitem_id'])

        # Adding M2M table for field establishment on 'Order'
        m2m_table_name = db.shorten_name(u'order_processor_order_establishment')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm[u'order_processor.order'], null=False)),
            ('establishment', models.ForeignKey(orm[u'order_processor.establishment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['order_id', 'establishment_id'])


    def backwards(self, orm):
        # Adding field 'Order.items'
        db.add_column(u'order_processor_order', 'items',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.SaleItem'], null=True),
                      keep_default=False)

        # Adding field 'Order.establishment'
        db.add_column(u'order_processor_order', 'establishment',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='establishment', null=True, to=orm['order_processor.Establishment']),
                      keep_default=False)

        # Removing M2M table for field items on 'Order'
        db.delete_table(db.shorten_name(u'order_processor_order_items'))

        # Removing M2M table for field establishment on 'Order'
        db.delete_table(db.shorten_name(u'order_processor_order_establishment'))
    ...
    models = {
        ...
        u'order_processor.order': {
            ...
            'city': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['order_processor.City']", 'unique': 'True'}),
            ...
            'establishment': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'establishment_set'", 'null': 'True', 'to': u"orm['order_processor.Establishment']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['order_processor.SaleItem']", 'null': 'True', 'symmetrical': 'False'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['order_processor.Profile']", 'unique': 'True', 'null': 'True'}),

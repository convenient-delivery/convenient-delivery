...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SaleItem.category'
        db.delete_column(u'order_processor_saleitem', 'category_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Order.cost'
        raise RuntimeError("Cannot reverse this migration. 'Order.cost' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Order.cost'
        db.add_column(u'order_processor_order', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=2),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'SaleItem.category'
        raise RuntimeError("Cannot reverse this migration. 'SaleItem.category' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SaleItem.category'
        db.add_column(u'order_processor_saleitem', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.ItemCategory']),
                      keep_default=False)
    ...
    models = {
        ...
        u'order_processor.establishment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['order_processor.SaleItem']", 'through': u"orm['order_processor.ItemCategory']", 'symmetrical': 'False'}),
        ...
        u'order_processor.itemcategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'sale_item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order_processor.SaleItem']", 'null': 'True'})
        },

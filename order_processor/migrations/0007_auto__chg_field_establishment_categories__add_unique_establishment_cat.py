...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Establishment.categories'
        db.alter_column(u'order_processor_establishment', 'categories_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['order_processor.ItemCategory'], unique=True, null=True))
        # Adding unique constraint on 'Establishment', fields ['categories']
        db.create_unique(u'order_processor_establishment', ['categories_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Establishment', fields ['categories']
        db.delete_unique(u'order_processor_establishment', ['categories_id'])


        # Changing field 'Establishment.categories'
        db.alter_column(u'order_processor_establishment', 'categories_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.ItemCategory'], null=True))
    ...
    models = {
        ...
        u'order_processor.establishment': {
            ...
            'categories': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['order_processor.ItemCategory']", 'unique': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

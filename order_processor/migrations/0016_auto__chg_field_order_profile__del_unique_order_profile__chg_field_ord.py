...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Order', fields ['city']
        db.delete_unique(u'order_processor_order', ['city_id'])

        # Removing unique constraint on 'Order', fields ['profile']
        db.delete_unique(u'order_processor_order', ['profile_id'])


        # Changing field 'Order.profile'
        db.alter_column(u'order_processor_order', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.Profile'], null=True))

        # Changing field 'Order.city'
        db.alter_column(u'order_processor_order', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.City']))

    def backwards(self, orm):

        # Changing field 'Order.profile'
        db.alter_column(u'order_processor_order', 'profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['order_processor.Profile'], unique=True, null=True))
        # Adding unique constraint on 'Order', fields ['profile']
        db.create_unique(u'order_processor_order', ['profile_id'])


        # Changing field 'Order.city'
        db.alter_column(u'order_processor_order', 'city_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['order_processor.City'], unique=True))
        # Adding unique constraint on 'Order', fields ['city']
        db.create_unique(u'order_processor_order', ['city_id'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'order_processor_order', 'establishment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.Establishment'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'order_processor.order': {
            ...
            'establishment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order_processor.Establishment']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

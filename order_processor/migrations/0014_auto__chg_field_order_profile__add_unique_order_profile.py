...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Order.profile'
        raise RuntimeError("Cannot reverse this migration. 'Order.profile' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Order.profile'
        db.alter_column(u'order_processor_order', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.Profile']))
    ...
    models = {
        ...
        u'order_processor.order': {
            ...
            'establishment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'establishment'", 'null': 'True', 'to': u"orm['order_processor.Establishment']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

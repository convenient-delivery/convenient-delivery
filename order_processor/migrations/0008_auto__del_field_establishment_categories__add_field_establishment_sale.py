...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Establishment.sale_items'
        db.add_column(u'order_processor_establishment', 'sale_items',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order_processor.SaleItem'], null=True),
                      keep_default=False)

        # Adding field 'ItemCategory.establishment'
        db.add_column(u'order_processor_itemcategory', 'establishment',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['order_processor.Establishment'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'order_processor_establishment', 'categories',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['order_processor.ItemCategory'], unique=True, null=True),
                      keep_default=False)

        # Deleting field 'Establishment.sale_items'
        db.delete_column(u'order_processor_establishment', 'sale_items_id')
    ...
    models = {
        ...
        u'order_processor.establishment': {
            ...
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'sale_items': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order_processor.SaleItem']", 'null': 'True'})
        },

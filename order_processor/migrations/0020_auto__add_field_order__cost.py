...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order._cost'
        db.add_column(u'order_processor_order', '_cost',
                      self.gf('django.db.models.fields.DecimalField')(default='0', db_column='cost', decimal_places=2, max_digits=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order._cost'
    ...
    models = {
        ...
        u'order_processor.order': {
            ...
            '_cost': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'db_column': "'cost'", 'decimal_places': '2', 'max_digits': '50'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['order_processor.City']"}),
